        ...
        @forelse($books as $book)
            <div class="group">
                <div
                    ...
                    <div class="relative aspect-[2/3] overflow-hidden">
                        ...
                        <div
                            ...
                            <button wire:click="showDetail('{{ $book->slug }}')"
                                class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-full text-sm font-medium transform -translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                                Lihat Detail
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        <h3
                            class="text-lg font-semibold text-neutral-800 dark:text-neutral-200 line-clamp-2 group-hover:text-red-500 transition-colors duration-200">
                            {{ $book->judul }}
                        </h3>
                        ...
                        <div class="mt-2 flex justify-between items-center">
                            ...
                            @if ($book->marketplace_links)
                                <button wire:click="showMarketplaces('{{ $book->slug }}')"
                                    class="text-sm text-neutral-600 dark:text-neutral-400 hover:text-red-500 dark:hover:text-red-400">
                                    Beli
                                </button>
                            @endif
                        </div>
            ...
            @if ($marketplaceLinks)
                <div class="space-y-4">
                    @foreach ($marketplaceLinks as $marketplace => $link)
                        <a href="{{ $link }}" target="_blank" rel="noopener noreferrer"
                            class="flex items-center justify-between p-4 rounded-lg border border-neutral-200 dark:border-neutral-700 hover:border-red-500 dark:hover:border-red-500 transition-colors duration-200">
