<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-6 text-neutral-900 dark:text-neutral-100">Edit Artikel</h2>
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            <div>
                ...
                <div
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        @elseif ($oldImage)
                            <img src="{{ asset($oldImage) }}" alt="Current Image"
            ...
            <div>
                ...
                <div wire:ignore>
                    <div id="konten" class="h-96 bg-white dark:bg-neutral-800">{!! $konten !!}</div>
                </div>
                @error('konten')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
