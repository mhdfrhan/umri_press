<div class="p-6">
    ...
    <div class="flex flex-wrap justify-between items-center mb-6">
        <a href="{{ route('semuaTim') }}" wire:navigate>
                ...
                <tbody class="bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700">
                    @forelse ($trashedTeam as $member)
                        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-700/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-neutral-500 dark:text-neutral-400">
                                    {{ $member->deleted_at->diffForHumans() }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex space-x-2">
                                    <button wire:click="confirmRestore({{ $member->id }})"
                                        class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                        Pulihkan
                                    </button>
                                    <button wire:click="confirmForceDelete({{ $member->id }})"
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 text-center text-neutral-500 dark:text-neutral-400">
                                Tidak ada anggota tim yang dihapus
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <x-modal name="confirmRestore" :show="false" align="center" maxWidth="md">
        <div class="p-6">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                Apakah Anda yakin ingin memulihkan anggota tim ini?
            </p>
    ...
    <x-modal name="confirmForceDelete" :show="false" align="center" maxWidth="md">
        <div class="p-6">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                Apakah Anda yakin ingin menghapus anggota tim ini secara permanen? Tindakan ini tidak dapat dibatalkan.
            </p>
            <div class="mt-6 flex justify-end space-x-3">
                <x-border-button class="!w-auto" x-on:click="$dispatch('close')">
                    Batal
    ...
    <x-modal name="confirmRestoreAll" :show="false" align="center" maxWidth="md">
        <div class="p-6">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                Apakah Anda yakin ingin memulihkan semua anggota tim yang ada di tempat sampah?
            </p>
            <div class="mt-6 flex justify-end space-x-3">
                <x-border-button class="!w-auto" x-on:click="$dispatch('close')">
                    Batal
    ...
    <x-modal name="confirmForceDeleteAll" :show="false" align="center" maxWidth="md">
        <div class="p-6">
            ...
            <p class="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                Apakah Anda yakin ingin menghapus semua anggota tim secara permanen? Tindakan ini tidak dapat dibatalkan.
            </p>
            <div class="mt-6 flex justify-end space-x-3">
                <x-border-button class="!w-auto" x-on:click="$dispatch('close')">
                    Batal
