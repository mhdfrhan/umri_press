<x-main-layout>
        ...
        <x-container>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm">
                    <div class="w-12 h-12 bg-cgreen-100 dark:bg-cgreen-800/80 rounded-xl flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-cgreen-600 dark:text-cgreen-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-16 bg-white dark:bg-neutral-950">
        <x-container>
            ...
            <div class="relative">
                <div class="hidden lg:block absolute left-0 right-0 top-1/2 mt-[0.5px] h-1 bg-cgreen-200 dark:bg-cgreen-800/40 -translate-y-1/2 mx-16">
                </div>
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <div
                                ...
                                <svg class="w-8 h-8 text-cgreen-500 dark:text-cgreen-200 group-hover:text-white" fill="none"
                        ...
                        <div class="hidden lg:block absolute -right-4 top-1/2 -translate-y-1/2 z-20">
                            <svg class="w-8 h-8 text-cgreen-600 dark:text-cgreen-800" fill="currentColor" viewBox="0 0 24 24">
                                <path
        ...
        <x-container>
            <div class="text-center text-white">
                ...
                <div class="flex flex-wrap justify-center gap-3 max-w-lg mx-auto">
                    ...
                    <x-secondary-button class="!w-auto !bg-transparent hover:!bg-cgreen-800/40 !shadow-none dark:hover:!bg-cgreen-900/80">
                        Hubungi Kami
                    </x-secondary-button>
                </div>
            </div>
