<x-main-layout>
    ...
    <section class="py-16 bg-white dark:bg-neutral-950">
        <x-container>
            <div class="text-center mb-12">
                ...
                <p class="text-neutral-600 max-w-2xl mx-auto dark:text-neutral-400">Kami menyediakan layanan penerbitan profesional dengan
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm">
                    <div class="w-12 h-12 bg-red-100 dark:bg-red-800/80 rounded-xl flex items-center justify-center mb-4">
                    ...
                    <p class="text-neutral-600 dark:text-neutral-400">Sebagai penerbit resmi UMRI, kami memiliki kredibilitas dan pengalaman
                ...
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm">
                    ...
                    <p class="text-neutral-600 dark:text-neutral-400">Kami menjamin proses penerbitan yang efisien dengan timeline yang jelas dan
                ...
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm">
                    ...
                    <p class="text-neutral-600 dark:text-neutral-400">Didukung oleh tim editor dan desainer profesional yang akan membantu
    ...
    <section class="py-16 bg-white dark:bg-neutral-950">
        <x-container>
            <div class="text-center mb-16">
                ...
                <p class="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">Kami menyediakan proses penerbitan yang terstruktur dan
                    transparan untuk memastikan kualitas terbaik</p>
            </div>

            <div class="relative">
                <div class="hidden lg:block absolute left-0 right-0 top-1/2 mt-[0.5px] h-1 bg-red-200 dark:bg-red-800/40 -translate-y-1/2 mx-16">
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 relative">
                    <div class="relative group">
                        <div
                            ...
                            <div
                                class="w-16 h-16 bg-red-100 dark:bg-red-800/80 rounded-full flex items-center justify-center mb-6 mx-auto group-hover:bg-red-600 transition-colors duration-300">
                                <svg class="w-8 h-8 text-red-500 dark:text-red-200 group-hover:text-white" fill="none"
                            ...
                            <div
                                class="absolute -top-3 -right-3 w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-lg">
                                1</div>

                            <h3 class="text-xl font-semibold text-center mb-4 text-neutral-800 dark:text-neutral-200">Pengajuan Naskah</h3>
                            <p class="text-neutral-600 text-center dark:text-neutral-400">Kirimkan naskah Anda melalui form pendaftaran online
                        ...
                        <div class="hidden lg:block absolute -right-4 top-1/2 -translate-y-1/2 z-20">
                            <svg class="w-8 h-8 text-red-600 dark:text-red-800" fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <h3 class="text-xl font-semibold text-center mb-4 text-neutral-800 dark:text-neutral-200">Review & Evaluasi</h3>
                            <p class="text-neutral-600 text-center dark:text-neutral-400">Tim editor kami akan melakukan review menyeluruh
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <h3 class="text-xl font-semibold text-center mb-4 text-neutral-800 dark:text-neutral-200">Proses Editing</h3>
                            <p class="text-neutral-600 text-center dark:text-neutral-400">Penyuntingan bahasa, tata letak, dan desain cover
                    ...
                    <div class="relative group">
                        <div
                            ...
                            <h3 class="text-xl font-semibold text-center mb-4 text-neutral-800 dark:text-neutral-200">Penerbitan</h3>
                            <p class="text-neutral-600 text-center dark:text-neutral-400">Proses cetak, ISBN, dan distribusi buku ke berbagai
                                channel pemasaran</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-red-600 dark:bg-red-800">
        <x-container>
