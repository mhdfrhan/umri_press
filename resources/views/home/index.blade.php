    ...
    <section class="py-24 bg-neutral-50 dark:bg-neutral-950">
        <x-container>
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h3 class="mt-2 text-3xl font-bold text-neutral-900 sm:text-4xl dark:text-neutral-200">Mendukung Publikasi Ilmiah Berkualitas
                </h3>
                <p class="mt-4 text-lg text-neutral-600 dark:text-neutral-400">Penerbit akademik yang berdedikasi untuk menyebarluaskan
            ...
            <div class="grid grid-cols-2 gap-6 md:grid-cols-3 mb-16">
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Layanan penerbitan buku akademik dan non-akademik dengan
                ...
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Proses pengiriman dan review naskah yang efisien dan
                        profesional</dd>
                </div>
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Layanan parafrase profesional untuk meningkatkan kualitas
                        tulisan akademik</dd>
                </div>
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Bimbingan dan konsultasi untuk mengembangkan keterampilan
                        menulis akademik</dd>
                </div>
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Koleksi lengkap buku akademik dan referensi ilmiah berkualitas
                    </dd>
                </div>
                <div class="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-sm shadow-neutral-200 dark:shadow-neutral-800 dark:hover:shadow-red-800/60 dark:hover:shadow-lg hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                    ...
                    <dd class="text-sm text-neutral-600 dark:text-neutral-500">Layanan distribusi dan pemasaran buku ke berbagai jaringan
                        toko buku</dd>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    <div class="space-y-4">
                        <span
                            class="inline-flex items-center px-3 py-1 text-sm font-medium text-red-500 dark:text-red-400 rounded-full bg-red-50 dark:bg-red-900/50">
                            Layanan Kami
                        </span>
                        <h4 class="text-2xl font-semibold text-neutral-900 dark:text-neutral-200">Mendukung Publikasi
                            Akademik Berkualitas
                        </h4>
                        <p class="text-neutral-600 dark:text-neutral-400">Kami menyediakan platform publikasi yang kredibel untuk karya
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg font-medium text-neutral-900 dark:text-neutral-200">Penerbitan Berkualitas</h5>
                                <p class="mt-1 text-neutral-600 dark:text-neutral-500">Penerbitan karya ilmiah berkualitas tinggi</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg font-medium text-neutral-900 dark:text-neutral-200">Inovasi dan Keunggulan</h5>
                                <p class="mt-1 text-neutral-600 dark:text-neutral-500">Inovasi dan keunggulan dalam penerbitan karya ilmiah
                                </p>
                            </div>
                        </div>
                    </div>
