...
@push('scripts')
    ...
    <script>
        function initializeSplide() {
            ...
            if (banner) {
                window.splideBanner = new Splide(banner, {
                    type: 'fade',  // Removed duplicate type
                    rewind: true,
                    autoplay: true,
                    interval: 5000,
                    arrows: false,
        ...
        // Move event listeners outside the function
...
@endpush
    ...
    <section class="py-14">
        <div class="relative">
            ...
            <div class="absolute left-0 top-0 bottom-0 w-40 bg-gradient-to-r from-white via-white/80 to-white/10"></div>
            <div class="absolute right-0 top-0 bottom-0 w-40 bg-gradient-to-l from-white via-white/80 to-white/10">
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-neutral-50">
        <x-container>
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-base font-semibold text-red-500 tracking-wide uppercase">Tentang Press UMRI</h2>
                <h3 class="mt-2 text-3xl font-bold text-neutral-900 sm:text-4xl">Mendukung Publikasi Ilmiah Berkualitas
                </h3>
                <p class="mt-4 text-lg text-neutral-600">Penerbit akademik yang berdedikasi untuk menyebarluaskan
                    pengetahuan melalui publikasi karya ilmiah berkualitas tinggi.</p>
            </div>

            <div class="grid grid-cols-2 gap-6 md:grid-cols-3 mb-16">
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        <svg class="w-8 h-8 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                        <dt class="text-2xl font-bold capitalize">Penerbitan Buku</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Layanan penerbitan buku akademik dan non-akademik dengan
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <dt class="text-2xl font-bold capitalize">Pengiriman Naskah</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Proses pengiriman dan review naskah yang efisien dan
                        profesional</dd>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <dt class="text-2xl font-bold capitalize">Jasa Parafrase</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Layanan parafrase profesional untuk meningkatkan kualitas
                        tulisan akademik</dd>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <dt class="text-2xl font-bold capitalize">Konsultasi Penulisan</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Bimbingan dan konsultasi untuk mengembangkan keterampilan
                        menulis akademik</dd>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <dt class="text-2xl font-bold capitalize">Toko Buku</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Koleksi lengkap buku akademik dan referensi ilmiah berkualitas
                    </dd>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm shadow-neutral-200 hover:shadow-xl duration-500">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <dt class="text-2xl font-bold capitalize">Distribusi</dt>
                    </div>
                    <dd class="text-sm text-neutral-600">Layanan distribusi dan pemasaran buku ke berbagai jaringan
                        toko buku</dd>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6">
                    <div class="space-y-4">
                        <span
                            class="inline-flex items-center px-3 py-1 text-sm font-medium text-red-500 rounded-full bg-blue-50">
                            Layanan Kami
                        </span>
                        <h4 class="text-2xl font-semibold text-neutral-900">Mendukung Publikasi Akademik Berkualitas
                        </h4>
                        <p class="text-neutral-600">Kami menyediakan platform publikasi yang kredibel untuk karya
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg font-medium text-neutral-900">Penerbitan Berkualitas</h5>
                                <p class="mt-1 text-neutral-600">Penerbitan karya ilmiah berkualitas tinggi</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg font-medium text-neutral-900">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <h5 class="text-lg font-medium text-neutral-900">Inovasi dan Keunggulan</h5>
                                <p class="mt-1 text-neutral-600">Inovasi dan keunggulan dalam penerbitan karya ilmiah
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-4">
                        <a href="#"
                            class="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-red-500 rounded-lg hover:bg-red-600 transition-colors duration-300">
                            Kirim Naskah
