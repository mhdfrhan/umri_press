...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-cgreen-400 text-start text-base font-medium text-cgreen-700 bg-cgreen-50 focus:outline-hidden focus:text-cgreen-800 focus:bg-cgreen-100 focus:border-cgreen-700 transition duration-150 ease-in-out'
